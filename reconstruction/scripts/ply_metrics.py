...
def main_component_ratio(xyz: np.ndarray, sample_n: int, seed: int) -> float:
    ...
    labels = DBSCAN(eps=eps, min_samples=10, algorithm='ball_tree').fit_predict(sample)
...
def main() -> int:
    ...
    parser.add_argument("--sample-n", type=int, default=10000, help="Sample size for expensive metrics.")
